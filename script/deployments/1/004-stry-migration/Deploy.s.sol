...
contract Deploy is Script {
    function run() external virtual {
        ...
        require(
            ...
            "Deploy: .stry has no code -- run Distribute.s.sol first to deploy EARN before this new StakedStrat instance."
        );
        ...
        console2.log("New StakedStrat (EARN/USDS) deployed:");
        ...
        console2.log("  Holders approve EARN for the staking contract, never the position token.");
        ...
        console2.log("- unstake() is whenNotTripped: a trip locks stakers' EARN in until untripped.");
        console2.log(
