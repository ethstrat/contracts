...
contract PresaleTokenRenderer is ITokenURIRenderer {
    function renderSvg(
        ...
        string memory svg = string.concat(
            ...
            '<rect x="16" y="16" width="258" height="468" rx="26" ry="26" stroke="#ffffff33"/>',
            // STRAT Logo
            ...
            // Title Text
            //'<text x="90" y="63" fill="black" font-family="sans-serif" font-size="24px" font-weight="500">ETH
            // Strategy</text>',
            //'<text x="145" y="93" text-anchor="middle" fill="black" font-family="sans-serif" font-size="16px"
            // font-weight="300">PRESAYLOR</text>',
            ...
            '<text x="30" y="440" fill="black" font-family="sans-serif" font-size="12px" font-weight="500">After launch, STRAT vests for 9 months:</text>',
            '<text x="30" y="455" fill="black" font-family="sans-serif" font-size="12px" font-weight="500">6 month cliff + 3 month linear unlock</text>',
            // Scrolling border text
