...
contract SimpleFlashLoanProvider {
    ...
    function flashLoan(
        ...
        bool success = receiverContract.onFlashLoan(
            tokenAddress,
            amount,
            fee,
            data
...
contract ESPNRedemptionQueueTest is Test {
    ...
    function test_MultipleUsersQueueAndRedeem() public {
        ...
        // Check final state
        assertEq(queue.totalRedemptionsProcessed(), actualRedemptionAmount1 + actualRedemptionAmount2 + actualRedemptionAmount3);
    }
    ...
    function test_QueueStatistics_Invariant() public {
        ...
        assertEq(processed + cancelled, actualRedemptionAmount1 + actualRedemptionAmount2); // Should be less than totalQueued
    }
